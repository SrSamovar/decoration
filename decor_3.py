...
def pars_vacancies(url, headers, params):
    ...
    for vacancy_tag in items:
        ...
        salary_tag = vacancy_soup.find("span",
                                       class_="magritte-text___pbpft_3-0-12 magritte-text_style-primary___AQ7MW_3-0-12 magritte-text_typography-label-1-regular___pi3R-_3-0-12")
